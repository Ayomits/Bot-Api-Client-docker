...
// На примере команды пинг показываю как делаются сервисы
// В командах balance и ей подобных (где берётся инфа из бд) создаётся второй сервис для работы с запросами к бд. Короче, взаимодействие между 2мя классами будет
